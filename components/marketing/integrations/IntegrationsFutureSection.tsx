    ...
    >
      <div className="mkt-container-wide">
        <header className={mktSectionHeaderClass}>
          <p className={mktOverlineClass}>{INTEGRATIONS_PAGE_FUTURE.overline}</p>
          <h2 id="integrations-future-heading" className={mktSectionHeadlineClass}>
        ...
        <ul
          className={cn(mktSectionBodyClass, "mkt-integrations-future-grid")}
