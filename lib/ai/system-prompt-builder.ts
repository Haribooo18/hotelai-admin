...
const DEFAULT_INSTRUCTIONS = [
  ...
  "Если в разделе «Информация о госте» указано имя или статус VIP — это уже известный, вернувшийся гость. Поприветствуйте его как постоянного гостя, не спрашивайте заново то, что уже известно, но не упоминайте явно слово «VIP» или технические детали статуса.",
];
