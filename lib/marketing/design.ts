...
export const mktSectionTightClass = "mkt-section-tight";
export const mktFaqSectionClass = "mkt-faq-section";
export const mktFaqShellClass = "mkt-faq-shell";
export const mktFaqListClass = "mkt-faq-list";
export const mktFaqQuestionClass = "mkt-faq-question";
export const mktFaqAnswerClass = "mkt-faq-answer";
export const mktCenteredFormSectionClass = "mkt-centered-form-section";
export const mktCenteredFormHeaderClass = "mkt-centered-form-header";
export const mktCenteredFormClass = "mkt-centered-form";
export const mktCenteredFormBodyClass = "mkt-centered-form-body";
export const mktFormTrustListClass = "mkt-form-trust-list";
export const mktFormTrustItemClass = "mkt-form-trust-item";
