...
export const iconActionClass =
  `inline-flex size-8 min-h-11 min-w-11 items-center justify-center rounded-[var(--ds-radius-sm)] text-[var(--shell-muted)] transition-[background-color,color,transform,opacity] duration-[var(--ds-duration)] ease-[var(--ds-ease)] hover:bg-[var(--shell-nav-hover-bg)] hover:text-[var(--shell-text)] active:scale-[0.98] sm:min-h-0 sm:min-w-0 ${focusRingClass}`;
...
export const tableRowClickableClass =
  `cursor-pointer border-b border-[var(--shell-border)]/35 transition-[background-color,box-shadow] duration-[var(--ds-duration)] ease-[var(--ds-ease)] last:border-0 hover:bg-[var(--shell-surface-raised)]/50 ${focusRingClass}`;

/** Clickable data table row — rooms/knowledge variant */
export const tableRowClickableAltClass =
  `cursor-pointer border-b border-[var(--shell-border)]/40 transition-[background-color] duration-[var(--ds-duration)] ease-[var(--ds-ease)] hover:bg-[var(--shell-surface-raised)]/50 ${focusRingClass}`;

/** View mode toggle button */
export const viewToggleButtonClass =
  `flex h-8 w-8 min-h-11 min-w-11 items-center justify-center rounded-[10px] transition-all duration-[var(--ds-duration)] ease-[var(--ds-ease)] sm:min-h-0 sm:min-w-0 ${focusRingClass}`;
